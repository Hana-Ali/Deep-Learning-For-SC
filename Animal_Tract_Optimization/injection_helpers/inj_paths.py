...
def main_mrtrix_folder_paths():
    ...
    return (GENERAL_MRTRIX_FOLDER, SPECIFIC_MRTRIX_FOLDER, ATLAS_REG_FOLDER_NAME, COMBINED_TRACTS_FOLDER_NAME, 
            ...
            INDIVIDUAL_ROIS_MIF_FOLDER_NAME)
...
def get_injection_roi_tracts_stats_path(REGION_ID, ROI_ID, TYPE="includes_both"):
    ...
    if TYPE == "includes_both":
        INJECTION_ROI_LENGTHS_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_BOTH_FOLDER, "ROI_{}_tracts_length.txt".format(ROI_ID))
        INJECTION_ROI_COUNT_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_BOTH_FOLDER, "ROI_{}_tracts_count.txt".format(ROI_ID))
        INJECTION_ROI_MEAN_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_BOTH_FOLDER, "ROI_{}_tracts_mean.txt".format(ROI_ID))
        INJECTION_ROI_MEDIAN_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_BOTH_FOLDER, "ROI_{}_tracts_median.txt".format(ROI_ID))
        INJECTION_ROI_STD_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_BOTH_FOLDER, "ROI_{}_tracts_std.txt".format(ROI_ID))
        INJECTION_ROI_MIN_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_BOTH_FOLDER, "ROI_{}_tracts_min.txt".format(ROI_ID))
        INJECTION_ROI_MAX_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_BOTH_FOLDER, "ROI_{}_tracts_max.txt".format(ROI_ID))
    elif TYPE == "includes_roi":
        INJECTION_ROI_LENGTHS_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ROI_ONLY_FOLDER, "ROI_{}_tracts_length.txt".format(ROI_ID))
        INJECTION_ROI_COUNT_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ROI_ONLY_FOLDER, "ROI_{}_tracts_count.txt".format(ROI_ID))
        INJECTION_ROI_MEAN_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ROI_ONLY_FOLDER, "ROI_{}_tracts_mean.txt".format(ROI_ID))
        INJECTION_ROI_MEDIAN_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ROI_ONLY_FOLDER, "ROI_{}_tracts_median.txt".format(ROI_ID))
        INJECTION_ROI_STD_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ROI_ONLY_FOLDER, "ROI_{}_tracts_std.txt".format(ROI_ID))
        INJECTION_ROI_MIN_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ROI_ONLY_FOLDER, "ROI_{}_tracts_min.txt".format(ROI_ID))
        INJECTION_ROI_MAX_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ROI_ONLY_FOLDER, "ROI_{}_tracts_max.txt".format(ROI_ID))
    elif TYPE == "includes_ends_only":
        INJECTION_ROI_LENGTHS_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ENDS_ONLY_FOLDER, "ROI_{}_tracts_length.txt".format(ROI_ID))
        INJECTION_ROI_COUNT_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ENDS_ONLY_FOLDER, "ROI_{}_tracts_count.txt".format(ROI_ID))
        INJECTION_ROI_MEAN_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ENDS_ONLY_FOLDER, "ROI_{}_tracts_mean.txt".format(ROI_ID))
        INJECTION_ROI_MEDIAN_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ENDS_ONLY_FOLDER, "ROI_{}_tracts_median.txt".format(ROI_ID))
        INJECTION_ROI_STD_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ENDS_ONLY_FOLDER, "ROI_{}_tracts_std.txt".format(ROI_ID))
        INJECTION_ROI_MIN_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ENDS_ONLY_FOLDER, "ROI_{}_tracts_min.txt".format(ROI_ID))
        INJECTION_ROI_MAX_PATH = os.path.join(INJECTION_ROI_TRACTS_STATS_INCLUDES_ENDS_ONLY_FOLDER, "ROI_{}_tracts_max.txt".format(ROI_ID))
    else:
        print("ERROR: Type {} not recognized".format(TYPE))
        sys.exit()

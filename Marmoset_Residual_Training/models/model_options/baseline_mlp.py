...
class Baseline_MLP(nn.Module):
    ...
    # Constructor
    def __init__(self, efficientnet_output_size, hidden_size, output_size, task="classification"):
        ...
        self.previous_predictions_size = 6
        ...
        self.combination_mlp = TwoInputMLP(previous_predictions_size=self.previous_predictions_size, efficientnet_output_size=self.efficientnet_output_size, 
                                           neurons=self.neurons, output_size=self.output_size, task=task)

...
streamline_arrays_path = os.path.join(main_logs_path, "conv_attention")
...
configs = {
    ...
    ####### Model #######
    "model_name" : "conv_attention", # Model name
    ...
    "num_rnn_hidden_neurons" : 1000, # Number of RNN hidden neurons
...
run_training(configs, metric_to_monitor=metric_to_monitor, bias=False)